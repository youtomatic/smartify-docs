...
<Cards>
  <Card href="/docs/products/lume/led-controller-cv-rgbpluscct" title="LED Controller (CV-RGB+CCT)">
    Every colour. Every white. One controller. — ₹9,247
  </Card>
  <Card href="/docs/products/lume/led-controller-cc-cct" title="LED Controller (CC-CCT)">
