...
<Cards>
  <Card href="/docs/products/reach/ir-blaster-wifi" title="IR Blaster (WiFi)">
    Every remote. One app. — ₹2,125
  </Card>
  <Card href="/docs/products/reach/irplusrf-blaster-wifi" title="IR+RF Blaster (WiFi)">
    IR and RF. Nothing left out. — ₹3,000
  </Card>
  <Card href="/docs/products/reach/ir-blaster-w--analog-screen-temp-and-humidity-sensor-wifi" title="IR Blaster w/ Analog Screen, Temp & Humidity Sensor (WiFi)">
